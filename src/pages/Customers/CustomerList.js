                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    <TableCell align="center" className="tableCell text-primary">Email</TableCell>
                                    <TableCell align="center" className="tableCell text-primary">Mobile Number</TableCell>
                            ...
                            <TableBody>
                                {customerData.map((row, index) => (
                                    <TableRow key={row.id}>
                                        ...
                                        <TableCell align="center" className="tableCell">
                                            <Link to={`/${row._id}/customerupdate`} style={{ textDecoration: "none"}}>
